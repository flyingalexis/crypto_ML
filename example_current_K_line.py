...
# # quote_ctx.get_history_kline(1, start=None, end=None, ktype='K_DAY', autype='qfq')
# quote_ctx.get_stock_quote([1]) # 获取报价
...
def _example_cur_kline(quote_ctx):
    ...
    for code in stock_code_list:
        for ktype in [ft.SubType.K_DAY, ft.SubType.K_1M, ft.SubType.K_5M]:
            ret_code, ret_data = quote_ctx.get_cur_kline(code, 10, ktype)
...
# 获取实时数据
# _example_stock_quote(quote_ctx)
